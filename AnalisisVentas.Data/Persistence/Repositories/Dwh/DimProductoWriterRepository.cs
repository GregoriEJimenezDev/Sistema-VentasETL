...
public class DimProductoWriterRepository : IDbWriterRepository<DimProducto>
{
    ...
    public async Task<(int Inserted, int Updated)> UpsertBatchAsync(IEnumerable<DimProducto> entities)
    {
        ...
        _logger.LogInformation("DimProducto carga completada — Insertados: {Inserted}, Actualizados: {Updated}", inserted, updated);
